...
- [ ] Todas as migrations estão criadas e testadas localmente
- [ ] Dados de seed foram aplicados no banco de produção
- [ ] Variáveis de ambiente de produção estão configuradas
- [ ] Chaves do Stripe estão no modo LIVE (não test)
- [ ] AUTH_SECRET foi gerado com comando seguro
- [ ] DATABASE_URL aponta para Neon (não localhost)
...
- [ ] Checkout e pagamento funcionam
- [ ] Webhook do Stripe está configurado e funcionando
- [ ] Imagens do Cloudinary carregam corretamente
- [ ] Emails (se configurado) estão sendo enviados
